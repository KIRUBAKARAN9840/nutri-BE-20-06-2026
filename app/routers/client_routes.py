...
from app.fittbot_api.v2.Fymble.nutrition_ad.routes import router as v2_nutrition_ad_router
from app.fittbot_api.v2.Fymble.apple_pg.routes import router as v2_apple_pg_router
from app.fittbot_api.v2.Fymble.webinar.routes import router as v2_webinar_router
...
from app.fittbot_api.v2.Fymble.gym_mate.profile import router as v2_gymmate_profile_router
from app.fittbot_api.v2.Fymble.gym_mate.stories import router as v2_gymmate_stories_router
from app.fittbot_api.v2.Fymble.gym_mate.sessions import router as v2_gymmate_sessions_router
from app.fittbot_api.v2.Fymble.gym_mate.home import router as v2_gymmate_home_router
from app.fittbot_api.v2.Fymble.gym_mate.blocks import router as v2_gymmate_blocks_router
from app.fittbot_api.v2.Fymble.gym_mate.reports import router as v2_gymmate_reports_router
from app.fittbot_api.v2.Fymble.gym_mate.friends import router as v2_gymmate_friends_router
from app.fittbot_api.v2.Fymble.gym_mate.notifications import (
    router as v2_gymmate_notifications_router,
    register_notification_handlers as _register_gymmate_notif_handlers,
)
# Wire the type-dispatching event bus → notification handlers once at
# import time. Idempotent — safe across uvicorn reloads.
_register_gymmate_notif_handlers()
from app.fittbot_api.v2.Fymble.gym_mate.chat import (
    router as v2_gymmate_chat_router,
    ws_router as v2_gymmate_chat_ws_router,
)
...
router.include_router(v2_nutrition_ad_router, prefix="/api/v2")
router.include_router(v2_apple_pg_router, prefix="/api/v2")
router.include_router(v2_webinar_router, prefix="/api/v2")
...
router.include_router(v2_gymmate_profile_router, prefix="/api/v2")
router.include_router(v2_gymmate_stories_router, prefix="/api/v2")
router.include_router(v2_gymmate_sessions_router, prefix="/api/v2")
router.include_router(v2_gymmate_home_router, prefix="/api/v2")
router.include_router(v2_gymmate_blocks_router, prefix="/api/v2")
router.include_router(v2_gymmate_reports_router, prefix="/api/v2")
router.include_router(v2_gymmate_friends_router, prefix="/api/v2")
router.include_router(v2_gymmate_chat_router, prefix="/api/v2")
router.include_router(v2_gymmate_chat_ws_router)
router.include_router(v2_gymmate_notifications_router, prefix="/api/v2")
