...
class TelecallerCoupon(Base):
    __tablename__ = "telecaller_coupons"
    __table_args__ = {"schema": "telecaller"}
    ...
    discount_percent = Column(Integer, nullable=False, default=5)
    is_used = Column(Boolean, nullable=False, default=False)
    used_by = Column(Integer, ForeignKey("clients.client_id", ondelete="SET NULL"), nullable=True)
