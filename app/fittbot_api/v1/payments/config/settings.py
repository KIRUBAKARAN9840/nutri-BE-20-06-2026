...
class PaymentSettings:
    ...
    def razorpay_payout_account_number(self) -> str:
        ...
        value = getattr(self._settings, 'razorpay_payout_account_number', None) or os.getenv("RAZORPAY_PAYOUT_ACCOUNT_NUMBER", "")
        if not value:
            import logging
            logging.getLogger("payments.settings").warning("RAZORPAY_PAYOUT_ACCOUNT_NUMBER not set")
        return value
