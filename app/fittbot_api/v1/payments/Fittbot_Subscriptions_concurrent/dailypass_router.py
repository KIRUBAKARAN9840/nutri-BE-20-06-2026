...
async def enqueue_dailypass_checkout(
    ...
    status_record = await dispatcher.enqueue_checkout(body, owner_id=str(client_id))
...
async def enqueue_dailypass_verify(
    ...
    status_record = await dispatcher.enqueue_verify(body, owner_id=str(client_id))
    status_url = request.url_for("get_dailypass_command_status", command_id=status_record.request_id)
...
async def enqueue_dailypass_upgrade_checkout(
    ...
    status_record = await dispatcher.enqueue_upgrade_checkout(body, owner_id=str(client_id))
    status_url = request.url_for("get_dailypass_command_status", command_id=status_record.request_id)
    return DailyPassCommandAccepted(
        request_id=status_record.request_id,
        status=status_record.status,
...
async def enqueue_dailypass_upgrade_verify(
    ...
    status_record = await dispatcher.enqueue_upgrade_verify(body, owner_id=str(client_id))
    status_url = request.url_for("get_dailypass_command_status", command_id=status_record.request_id)
    return DailyPassCommandAccepted(
        request_id=status_record.request_id,
        status=status_record.status,
...
async def enqueue_dailypass_edit_topup_checkout(
    ...
    body.client_id = str(client_id)
    status_record = await dispatcher.enqueue_edit_topup_checkout(body, owner_id=str(client_id))
    status_url = request.url_for("get_dailypass_command_status", command_id=status_record.request_id)
    return DailyPassCommandAccepted(
        request_id=status_record.request_id,
        status=status_record.status,
...
async def enqueue_dailypass_edit_topup_verify(
    ...
    status_record = await dispatcher.enqueue_edit_topup_verify(body, owner_id=str(client_id))
    status_url = request.url_for("get_dailypass_command_status", command_id=status_record.request_id)
    return DailyPassCommandAccepted(
        request_id=status_record.request_id,
        status=status_record.status,
