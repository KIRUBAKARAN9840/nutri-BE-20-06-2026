...
from app.config.constants import PRESIGN_EXPIRY_SECONDS
from app.services.s3_service import AWS_REGION, BUCKET_NAME, get_upload_s3

_s3 = get_upload_s3()

from app.services.nutrition_calculator import calculate_age
...
from app.services.phone_utils import normalize_phone as normalize_contact
