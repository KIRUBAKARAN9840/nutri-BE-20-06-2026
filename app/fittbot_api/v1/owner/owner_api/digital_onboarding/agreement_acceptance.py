...
from app.config.constants import PRESIGN_EXPIRY_SECONDS, OTP_EXPIRY_SECONDS
...
def generate_presigned_url(gym_id: int, file_type: str, extension: str, content_type: str) -> Dict:
    ...
    presigned = _s3.generate_presigned_post(
        ...
        ExpiresIn=PRESIGN_EXPIRY_SECONDS,  # 10 minutes
    )
...
async def send_otp(
    ...
    try:
        ...
        await redis.set(otp_key, otp, ex=OTP_EXPIRY_SECONDS)  # 5 minutes expiry
