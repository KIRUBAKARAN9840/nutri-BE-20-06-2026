    ...
    try:
        ...
        if cached_plans:
            ...
            if plans_records:
                ...
                await redis.set(redis_key_plans, json.dumps(plans_data_for_cache), ex=CACHE_TTL_LONG)
        ...
        if cached_batches:
            ...
            if not batches_records:
                ...
                await redis.set(redis_key_batches, json.dumps(batches_data), ex=CACHE_TTL_LONG)
