...
LOAD_TEST_SECRET_KEY = os.getenv("LOAD_TEST_SECRET_KEY")
if not LOAD_TEST_SECRET_KEY:
    import logging
    logging.getLogger(__name__).warning("LOAD_TEST_SECRET_KEY not set — load test endpoints will reject all requests")
    LOAD_TEST_SECRET_KEY = ""
