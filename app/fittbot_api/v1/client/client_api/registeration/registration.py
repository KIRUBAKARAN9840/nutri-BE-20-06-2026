...
from app.services.client_service import async_get_client_or_404
...
# ==================== Helper Functions ====================
# calculate_age, calculate_bmi, calculate_bmr, calculate_macros,
# activity_multipliers, get_water_intake → imported from app.services.nutrition_calculator
# async_get_client_or_404 → imported from app.services.client_service

# Keep backward-compatible alias used within this file
get_client_by_id = async_get_client_or_404
...
async def register_client(
    ...
    try:
        ...
        mobile_otp=secure_generate_otp(request.mobile_number)
