...
# Async OpenAI imports (direct calls, no Celery)
...
Analyze this input and determine what the user wants to do."""
    ...
    async def analyze_user_intent_celery(user_id: int, user_input: str, conversation_context: Dict[str, Any] = None) -> Dict[str, Any]:
        """
        Analyze user intent for workout template chatbot.
...
Analyze this input and determine what the user wants to do."""
        ...
        try:
            ...
            print(f"Error in analyze_user_intent_celery: {e}")
            return {
                "intent": "unclear",
                "confidence": 0.0,
                "days_count": None,
    ...
    async def determine_conversation_flow_celery(user_id: int, user_input: str, current_state: str, context: Dict[str, Any]) -> Dict[str, Any]:
        """
        Determine conversation flow for workout template chatbot.
        Direct async OpenAI call (no Celery overhead).
        ...
        system_prompt = f"""You are managing a workout template creation conversation. Based on the user input and current context, determine what should happen next.
...
What should be the next state?"""
        ...
        try:
            ...
            print(f"Error in determine_conversation_flow_celery: {e}")
            return {
...
Generate an appropriate response for this situation."""
    ...
    async def generate_contextual_response_celery(user_id: int, conversation_state: str, user_input: str, context: Dict[str, Any]) -> str:
        """
        Generate natural, contextual responses for workout conversations.
        Direct async OpenAI call (no Celery overhead).
...
Generate an appropriate response for this situation."""
        ...
        try:
            ...
            print(f"Error in generate_contextual_response_celery: {e}")
