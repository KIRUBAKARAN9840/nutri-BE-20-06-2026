...
BLOCKED_WORDS = {
    ...
    # English profanity
    "fuck", "shit", "ass", "bitch", "dick", "bastard", "cunt",
    "damn", "crap", "piss", "slut", "whore",

    # Tamil profanity (transliterated)
    "punda", "pundai", "pundek", "otha", "ommala", "thevdiya",
    "thevidiya", "thevudiya", "sunni", "soothu", "baadu", "baadு",
    "myiru", "mayiru", "mayir", "oombu", "koothi", "poolu",
    "lavda", "venna", "vesai", "vesi", "thaiyoli", "thayoli",
    "okka", "ennoda", "kunji",

    # Hindi profanity (transliterated)
    "chutiya", "chutiye", "madarchod", "bhenchod", "behenchod",
    "bhosdike", "bhosdiwale", "gaand", "gandu", "lund", "lodu",
    "randi", "harami", "haramkhor", "sala", "saala", "kamina",
    "kamine", "jhatu", "chodu", "chodna",

    # Telugu profanity (transliterated)
    "dengey", "dengu", "pooku", "gudda", "lanja", "lanjakodaka",
    "modda", "sulli", "donga", "erripuka",

    # Kannada profanity (transliterated)
    "sule", "magne", "bolimaga", "hendti", "tunne",

    # Malayalam profanity (transliterated)
    "myre", "thayoli", "patti", "kunna", "pooru", "thendi",
}
